...
for (const pic of picArray) {
  ...
  title.appendChild(document.createTextNode(pic.title));
  img.src = pic.image.medium;
  img.alt = pic.title;
  caption.appendChild(document.createTextNode(pic.caption));
  desc.appendChild(document.createTextNode(pic.description));
